    ...
    children: [
      {
        path: "discover",
        component: () =>
          import(/* webpackChunkName: "blank-page" */ "./views/app/discover")
      },

      {
        path: "preferences",
        component: () =>
          import(/* webpackChunkName: "blank-page" */ "./views/app/favourites")
      },
      {
        path: "settings",
        component: () =>
          import(/* webpackChunkName: "blank-page" */ "./views/app/matches")
      },
      {
        path: "Awards",
        component: () =>
          import(/* webpackChunkName: "blank-page" */ "./views/app/powerup")
      },
      {
        path: "search",
        component: () =>
          import(/* webpackChunkName: "blank-page" */ "./views/app/search")
      },
      {
        path: "profile",
        component: () =>
          import(/* webpackChunkName: "blank-page" */ "./views/app/events")
      },
      {
        path: "views",
        component: () =>
          import(/* webpackChunkName: "blank-page" */ "./views/app/view")
      }
    ]
  },
  {
