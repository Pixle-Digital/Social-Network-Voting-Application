    ...
    <b-row>
      <b-col lg="12" md="12" sm="12">
        <div class="h-100 form-side mt-5">
          ...
          <div>
            <p class="title p-0 m-0">Welcome!</p>
            <p class="subtitle p-0 mt-2 ml-1">Sign up</p>
            ...
            >
              ...
              <b-form-checkbox-group stacked class="mb-3">
            <b-form-checkbox v-model="$v.form.agree.$model" value="first">I certify that I am at least 16 years old and I agree to the websites terms and conditions.</b-form-checkbox>
